...
int EliminarAcc(vector<vector<char>>& grid, int filas, int columnas){
...
int main() {
    ...
    int AccAhora;
    do{
        AccAhora = EliminarAcc(grid, filas, columnas);
        TotalAcc += AccAhora;
        
    } while (AccAhora > 0);

    cout << "Total de rollos de papel eliminados: " << TotalAcc << endl;
